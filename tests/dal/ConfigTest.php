...
final class ConfigTest extends TestCase
{
    ...
    public function test_get_config_returns_default_when_absent(): void
    {
        $this->assertSame('fallback', dal_get_config($this->pdo, 'inexistant', 'fallback'));
        $this->assertNull(dal_get_config($this->pdo, 'inexistant'));
    }
    ...
    public function test_set_then_get_config(): void
    {
        ...
        $this->assertSame('ma_valeur', dal_get_config($this->pdo, 'ma_cle'));
    }
    ...
    public function test_set_config_upserts(): void
    {
        ...
        $this->assertSame('v2', dal_get_config($this->pdo, 'ma_cle'));
